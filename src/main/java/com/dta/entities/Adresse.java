...
@Entity
@NamedQueries({
	@NamedQuery(name="Adresse.findByAdresse", query="SELECT a FROM Adresse a WHERE code_postal=:codepostal AND departement=:departement AND numero=:numero AND pays=:pays AND rue=:rue AND ville=:ville")
})
